    ...
    'ojs/ojinputtext'
        ...
        function (oj, ko, $, utils) {
          ...
          $(function () {
            ...
            router.configure({
                'flights': {label: '航班', isDefault: true},
                'hotels': {label: '酒店'},
                'booking': {label: '订单'},
                'update': {label: '后台管理'}
            });
            ...
            function MainViewModel() {
                ...
                self.dynamicConfig = ko.pureComputed(function () {
                    if (self.smallOnly()) {
                        return {name: 'flights/' + router.moduleConfig.name(), lifecycleListner: router.moduleConfig.lifecycleListner, params: router.moduleConfig.params};
                    }
